            ...
            commandFiles.map((value) => {
                ...
                if (file.name) {
                  ...
                  embed.setDescription(`**__Prefix:__** \`${prefix}\`\n**__Commands:__** \`${client.commands.size}\`\n**__Slash:__** \`${client.slashCommands.size}\`\n**__Developer:__** [𝐌𝐚𝐆𝐝𝐄𝐞](https://discord.com/users/1150890847768936458)\n`)
                    embed.addFields({ name: `<:line_ma:1229863001058840708> ${prefix}${properties.name}` , value: `------------------`, inline: false})
                }
            });
...
*/
            embed.setFooter({ text: `Type: (${prefix}about) to view the bot info`, iconURL: message.guild.iconURL({ dynamic: true }) })
            embed.setTimestamp()
